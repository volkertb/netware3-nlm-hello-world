/**
 * Copied from https://forum.osdev.org/viewtopic.php?p=69240#p69240
 */

#include "nlm_io_wrapper.c"
...
int init_graph_vga(int width, int height,int chain4) // returns 1=ok, 0=fail
{
   const byte *w,*h;
   byte val;
   int a;
