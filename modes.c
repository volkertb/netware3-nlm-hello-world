...
// Added this to allow this code to be used in Novell NLMs built with GCC
#elif defined(__GNUC__)
// Uncomment the line below to use the I/O port programming routines from FreeBSD instead
#define USE_NLM_SDK_IO
#ifdef USE_NLM_SDK_IO
#define	inportb(P)		inp(P)
#define	outportb(P,V)	outp(P,V)
#else
#include "cpufunc.h"
...
/*****************************************************************************
*****************************************************************************/
int main_model_c(int arg_c, char *arg_v[])
{
	//dump_state();
